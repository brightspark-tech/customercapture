...
5. **Create a new file: AddCustomer2.tsx**
  ```typescript
    import { Text, View, SafeAreaView } from "react-native";
...
6. **Integrate these screens into the layout file**
  ...
  export default function Layout() {
    return (
      <Stack>
        ...
        <Stack.Screen name="AddCustomer2" options={{ title: "Add Customer" }} />
      </Stack>
    );
  }
  ```
...
2. **Open the `AddCustomer2.tsx` file** and replace its content with the following:
```typescript
  ...
  export default function AddCustomer2()
  {
     ...
     return (
       <FormProvider>
         <Stack>
           ...
           <Stack.Screen name="AddCustomer2" options={{ headerShown: false }} />
